  ...
  const handleDelete = async () => {
    try {
      ...
      if (result.isConfirmed) {
        ...
        {data:{ role: "CallCenter" }} // Ensure to send role in the request body if required
        );
        ...
        {isModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 z-50">
            <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 lg:w-full lg:h-auto w-[300px] h-auto max-w-lg mx-2 sm:mx-4 md:mx-6 lg:mx-auto xl:mx-auto">
              <h2 className="lg:text-2xl text-xl font-bold mb-4 text-[#5443c3]">Register for Call Center Team</h2>
