    ...
    try {
      ...
      if (result.isConfirmed) {
        const response = await axios.delete(`${BASE_URL}/api/allUser/users`, 
          {
          data: { role: "VirtualTeam" } // Send role in the request body
        } // Ensure to send role in the request body if required
        );
...
<Sidebar/>
    ...
    <div className="flex justify-between mb-4 flex-col lg:flex-row">
          <h1 className="text-xl sm:text-2xl font-bold text-[#5443c3]">Virtual Team Details</h1>
        ...
        {isModalOpen && (
          ...
          <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 lg:w-full lg:h-auto w-[300px] h-auto max-w-lg mx-2 sm:mx-4 md:mx-6 lg:mx-auto xl:mx-auto">
            <h2 className="lg:text-2xl text-xl font-bold mb-4 text-[#5443c3]">Register for Virtual Team</h2>
