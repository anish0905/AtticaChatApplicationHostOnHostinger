...
const FrontendCamera = ({ onCapture, onClose, recipient, loggedInUserId, admin }) => {
    ...
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black bg-opacity-75">
      ...
      <div className="mt-4 flex space-x-4">
        <button
          ...
          className="px-4 py-2 bg-blue-500 text-white lg:text-xl text-xs rounded-lg"
